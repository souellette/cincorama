...
$installer->run("
	CREATE TABLE IF NOT EXISTS {$this->getTable('dynamicslideshow/sliders')} (
		`id` INT(10) NOT NULL AUTO_INCREMENT,
		`title` VARCHAR(255) NOT NULL,
		`alias` VARCHAR(255) NOT NULL DEFAULT '',
		`params` TEXT NOT NULL,
		`status` INT(10) NULL DEFAULT NULL,
		`store_ids` VARCHAR(255) NULL DEFAULT NULL,
	  PRIMARY KEY (`id`)
	) ENGINE=InnoDB DEFAULT CHARSET=utf8;

	CREATE TABLE IF NOT EXISTS {$this->getTable('dynamicslideshow/slides')} (
	...
	CREATE TABLE IF NOT EXISTS {$this->getTable('dynamicslideshow/animation')} (
	  `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	CREATE TABLE IF NOT EXISTS {$this->getTable('dynamicslideshow/css')} (
	  `id` int(11) NOT NULL AUTO_INCREMENT,
	...
	INSERT INTO {$this->getTable('dynamicslideshow/css')} (`handle`, `settings`, `hover`, `params`) VALUES
